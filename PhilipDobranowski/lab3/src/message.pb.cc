...
const ::uint32_t TableStruct_message_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::lab3Proto::SimpleMessage, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::lab3Proto::SimpleMessage, _impl_.sender_name_),
    PROTOBUF_FIELD_OFFSET(::lab3Proto::SimpleMessage, _impl_.message_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::lab3Proto::SimpleMessage)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::lab3Proto::_SimpleMessage_default_instance_._instance,
};
const char descriptor_table_protodef_message_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\rmessage.proto\022\tlab3Proto\"5\n\rSimpleMess"
...
SimpleMessage::SimpleMessage(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:lab3Proto.SimpleMessage)
}
...
SimpleMessage::SimpleMessage(
  ...
  // @@protoc_insertion_point(copy_constructor:lab3Proto.SimpleMessage)
}
inline PROTOBUF_NDEBUG_INLINE SimpleMessage::Impl_::Impl_(
...
SimpleMessage::~SimpleMessage() {
  // @@protoc_insertion_point(destructor:lab3Proto.SimpleMessage)
...
// @@protoc_insertion_point(message_clear_start:lab3Proto.SimpleMessage)
...
const ::_pbi::TcParseTable<1, 2, 0, 50, 2> SimpleMessage::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastUS1,
     {18, 63, 0, PROTOBUF_FIELD_OFFSET(SimpleMessage, _impl_.message_)}},
    ...
    // string message = 2;
    {PROTOBUF_FIELD_OFFSET(SimpleMessage, _impl_.message_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUtf8String | ::_fl::kRepAString)},
  }},
  // no aux_entries
  {{
    "\27\13\7\0\0\0\0\0"
    "lab3Proto.SimpleMessage"
    "sender_name"
    "message"
  }},
};
...
::uint8_t* SimpleMessage::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:lab3Proto.SimpleMessage)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_sender_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lab3Proto.SimpleMessage.sender_name");
  ...
  if (!this->_internal_message().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "lab3Proto.SimpleMessage.message");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:lab3Proto.SimpleMessage)
  return target;
}

::size_t SimpleMessage::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:lab3Proto.SimpleMessage)
  ::size_t total_size = 0;
...
void SimpleMessage::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:lab3Proto.SimpleMessage)
...
// @@protoc_insertion_point(class_specific_copy_from_start:lab3Proto.SimpleMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
