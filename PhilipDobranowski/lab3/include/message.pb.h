...
class SimpleMessage final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:lab3Proto.SimpleMessage) */ {
 public:
  ...
  static ::absl::string_view FullMessageName() {
    return "lab3Proto.SimpleMessage";
  }
  protected:
  ...
  public:
  // @@protoc_insertion_point(class_scope:lab3Proto.SimpleMessage)
 private:
  class _Internal;
...
inline const std::string& SimpleMessage::sender_name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:lab3Proto.SimpleMessage.sender_name)
...
inline PROTOBUF_ALWAYS_INLINE void SimpleMessage::set_sender_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:lab3Proto.SimpleMessage.sender_name)
}
inline std::string* SimpleMessage::mutable_sender_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ...
  // @@protoc_insertion_point(field_mutable:lab3Proto.SimpleMessage.sender_name)
  return _s;
}
...
inline std::string* SimpleMessage::release_sender_name() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:lab3Proto.SimpleMessage.sender_name)
...
inline void SimpleMessage::set_allocated_sender_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:lab3Proto.SimpleMessage.sender_name)
}
...
inline const std::string& SimpleMessage::message() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:lab3Proto.SimpleMessage.message)
  return _internal_message();
}
template <typename Arg_, typename... Args_>
inline PROTOBUF_ALWAYS_INLINE void SimpleMessage::set_message(Arg_&& arg,
                                                     Args_... args) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
  _impl_.message_.Set(static_cast<Arg_&&>(arg), args..., GetArena());
  // @@protoc_insertion_point(field_set:lab3Proto.SimpleMessage.message)
}
inline std::string* SimpleMessage::mutable_message() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_message();
  // @@protoc_insertion_point(field_mutable:lab3Proto.SimpleMessage.message)
  return _s;
}
...
inline std::string* SimpleMessage::release_message() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:lab3Proto.SimpleMessage.message)
  return _impl_.message_.Release();
}
inline void SimpleMessage::set_allocated_message(std::string* value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ...
  #endif  // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:lab3Proto.SimpleMessage.message)
}
