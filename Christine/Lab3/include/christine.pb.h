...
#ifndef GOOGLE_PROTOBUF_INCLUDED_proto_2fchristine_2fchristine_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_proto_2fchristine_2fchristine_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_proto_2fchristine_2fchristine_2eproto;
namespace christine {
class Client;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::christine::Client* Arena::CreateMaybeMessage<::christine::Client>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace christine {
...
class Client final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:christine.Client) */ {
 public:
...
void Client::set_sender_name(ArgT0&& arg0, ArgT... args) {
...
inline std::string* Client::mutable_sender_name() {
...
inline void Client::set_allocated_sender_name(std::string* sender_name) {
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Client::set_message(ArgT0&& arg0, ArgT... args) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_proto_2fchristine_2fchristine_2eproto
