...
static ::_pb::Metadata file_level_metadata_socket_2eproto[1];
static constexpr const ::_pb::EnumDescriptor**
    file_level_enum_descriptors_socket_2eproto = nullptr;
static constexpr const ::_pb::ServiceDescriptor**
    file_level_service_descriptors_socket_2eproto = nullptr;
const ::uint32_t TableStruct_socket_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
    ~0u,  // no _has_bits_
    PROTOBUF_FIELD_OFFSET(::tutorial::SimpleMessage, _internal_metadata_),
    ~0u,  // no _extensions_
    ~0u,  // no _oneof_case_
    ...
    ~0u,  // no _split_
    ~0u,  // no sizeof(Split)
    PROTOBUF_FIELD_OFFSET(::tutorial::SimpleMessage, _impl_.sender_name_),
};

static const ::_pbi::MigrationSchema
    schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
        {0, -1, -1, sizeof(::tutorial::SimpleMessage)},
};

static const ::_pb::Message* const file_default_instances[] = {
    &::tutorial::_SimpleMessage_default_instance_._instance,
};
const char descriptor_table_protodef_socket_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
    "\n\014socket.proto\022\010tutorial\"$\n\rSimpleMessag"
    "e\022\023\n\013sender_name\030\001 \001(\tb\006proto3"
};
static ::absl::once_flag descriptor_table_socket_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_socket_2eproto = {
    false,
    false,
    70,
    descriptor_table_protodef_socket_2eproto,
    "socket.proto",
    &descriptor_table_socket_2eproto_once,
    nullptr,
    0,
    1,
    schemas,
    file_default_instances,
    TableStruct_socket_2eproto::offsets,
    file_level_metadata_socket_2eproto,
    file_level_enum_descriptors_socket_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_socket_2eproto(&descriptor_table_socket_2eproto);
namespace tutorial {
// ===================================================================
...
SimpleMessage::SimpleMessage(::google::protobuf::Arena* arena)
  ...
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:tutorial.SimpleMessage)
}
...
SimpleMessage::SimpleMessage(
  ...
  // @@protoc_insertion_point(copy_constructor:tutorial.SimpleMessage)
}
inline PROTOBUF_NDEBUG_INLINE SimpleMessage::Impl_::Impl_(
...
SimpleMessage::~SimpleMessage() {
  // @@protoc_insertion_point(destructor:tutorial.SimpleMessage)
...
// @@protoc_insertion_point(message_clear_start:tutorial.SimpleMessage)
...
const ::_pbi::TcParseTable<0, 1, 0, 42, 2> SimpleMessage::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
...
::uint8_t* SimpleMessage::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:tutorial.SimpleMessage)
  ::uint32_t cached_has_bits = 0;
  (void)cached_has_bits;
  ...
  if (!this->_internal_sender_name().empty()) {
    ...
    ::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
        _s.data(), static_cast<int>(_s.length()), ::google::protobuf::internal::WireFormatLite::SERIALIZE, "tutorial.SimpleMessage.sender_name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:tutorial.SimpleMessage)
  return target;
}

::size_t SimpleMessage::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:tutorial.SimpleMessage)
  ::size_t total_size = 0;
...
void SimpleMessage::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:tutorial.SimpleMessage)
...
// @@protoc_insertion_point(class_specific_copy_from_start:tutorial.SimpleMessage)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
