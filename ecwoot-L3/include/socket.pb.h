...
#ifndef GOOGLE_PROTOBUF_INCLUDED_socket_2eproto_2epb_2eh
#define GOOGLE_PROTOBUF_INCLUDED_socket_2eproto_2epb_2eh
...
extern const ::google::protobuf::internal::DescriptorTable
    descriptor_table_socket_2eproto;
namespace tutorial {
class SimpleMessage;
...
class SimpleMessage final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:tutorial.SimpleMessage) */ {
 public:
  ...
  public:
  // @@protoc_insertion_point(class_scope:tutorial.SimpleMessage)
 private:
  class _Internal;
...
inline const std::string& SimpleMessage::sender_name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:tutorial.SimpleMessage.sender_name)
...
inline PROTOBUF_ALWAYS_INLINE void SimpleMessage::set_sender_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:tutorial.SimpleMessage.sender_name)
}
inline std::string* SimpleMessage::mutable_sender_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  ...
  // @@protoc_insertion_point(field_mutable:tutorial.SimpleMessage.sender_name)
  return _s;
}
...
inline std::string* SimpleMessage::release_sender_name() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:tutorial.SimpleMessage.sender_name)
...
inline void SimpleMessage::set_allocated_sender_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:tutorial.SimpleMessage.sender_name)
}
...
#endif  // GOOGLE_PROTOBUF_INCLUDED_socket_2eproto_2epb_2eh
