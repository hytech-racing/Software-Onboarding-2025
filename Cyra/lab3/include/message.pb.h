...
class CarMsg final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:carmessage.CarMsg) */ {
 public:
  inline CarMsg() : CarMsg(nullptr) {}
  ~CarMsg() override;
  template<typename = void>
  explicit PROTOBUF_CONSTEXPR CarMsg(::google::protobuf::internal::ConstantInitialized);

  inline CarMsg(const CarMsg& from)
      : CarMsg(nullptr, from) {}
  ...
  CarMsg* New(::google::protobuf::Arena* arena = nullptr) const final {
