...
class data final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:message.data) */ {
 public:
...
inline const std::string& data::sender_name() const
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  // @@protoc_insertion_point(field_get:message.data.sender_name)
...
inline PROTOBUF_ALWAYS_INLINE void data::set_sender_name(Arg_&& arg,
  ...
  // @@protoc_insertion_point(field_set:message.data.sender_name)
}
inline std::string* data::mutable_sender_name() ABSL_ATTRIBUTE_LIFETIME_BOUND {
  std::string* _s = _internal_mutable_sender_name();
  // @@protoc_insertion_point(field_mutable:message.data.sender_name)
  return _s;
}
...
inline std::string* data::release_sender_name() {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  // @@protoc_insertion_point(field_release:message.data.sender_name)
...
inline void data::set_allocated_sender_name(std::string* value) {
  ...
  // @@protoc_insertion_point(field_set_allocated:message.data.sender_name)
}
